            ...
            {testimonials.map((t) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-gray-100">
                  <div
                    className="w-11 h-11 rounded-full flex items-center justify-center text-[13px] font-extrabold text-[#1F1F1F]"
                  ...
                  <div>
                    ...
                    <div className="text-[11px] text-[#00BA74] font-semibold mt-0.5">
                      {t.product}
                    </div>
                  </div>
                </div>
